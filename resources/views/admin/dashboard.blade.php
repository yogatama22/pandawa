...
<div class="row g-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.testimonials.create') }}" class="btn btn-outline-info text-start">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.company-profile.index') }}" class="btn btn-outline-secondary text-start">
                        <i class="bi bi-building me-2"></i>Company Profile
                    </a>
                    <a href="{{ route('admin.about.index') }}" class="btn btn-outline-secondary text-start">
