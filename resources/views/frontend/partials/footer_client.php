            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-30">
                    <div class="item fotcont">
                        ...
                        <p>Perumahan Royal Palace Blok B-8, Beji, Boyolangu, Tulungagung</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="sub-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="text-left">
                            <p>© 2025 Pandawa Renjana. All right reserved.</p>
                        </div>
                    </div>
